class Library
  ...
  BOOK_TYPES = [
    ...
    BookType.new("BIOGRAPHY", "#{ADULT}+#{NON_FICTION}+4293412635"),
    BookType.new("CANADIAN_POETRY", "#{ADULT}+4293411560"),
    BookType.new("CHILD_REARING", "#{ADULT}+#{NON_FICTION}+4293412106"),
    BookType.new("CONDUCT_OF_LIFE", "#{ADULT}+#{NON_FICTION}+4293412367"),
    BookType.new("DECISION_MAKING", "#{ADULT}+#{NON_FICTION}+4293407806"),
    BookType.new("DESIGN", "#{ADULT}+#{NON_FICTION}+4293412245"),
    BookType.new("DRAWING", "#{ADULT}+#{NON_FICTION}+4293412549"),
    ...
    BookType.new("NATURE", "#{ADULT}+#{NON_FICTION}+4293410500"),
    BookType.new("PERSONAL_FINANCE", "#{ADULT}+#{NON_FICTION}+4293407417"),
    BookType.new("PHYSICAL_FITNESS", "#{ADULT}+#{NON_FICTION}+4293411122"),
    BookType.new("PLANNING", "#{ADULT}+#{NON_FICTION}+4293410908"),
    BookType.new("POETRY", "#{ADULT}+4293411909"),
    BookType.new("RUBY", "#{ADULT}+#{NON_FICTION}+4293316407"),
    BookType.new("SOCIAL_PSYCHOLOGY", "#{ADULT}+#{NON_FICTION}+4293406987"),
    BookType.new("STUDY_AND_TEACHING", "#{ADULT}+#{NON_FICTION}+4293412474"),
